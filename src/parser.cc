...
bool	HasKet (char *s);
void	master_parser (char *buf, Character *ch, Room *room, Object *obj);
...
int		lexical_analyser (char *in_string, Character *ch);
char	lookup_value (char *variable, int *value, Character *ch, Room *room, Object *obj);
...
int		power10 (int num);
void	clean_up (char *in, Character *ch);
...
//			buf2[0] = '\0';
		...
		for (l = i; l < (i + (SInt32)(strlen (tmp))); l++)	buf[l] = tmp[l - i];
...
char lookup_value (char *variable, int *value, Character *ch, Room *room, Object *obj) {
	const char *var_list[] = {
		...
		"time"	, "level"	,	//	6-7
		"weight"	, "height"	, 
		"isanimal",	"ishyumann",	"iself", "isdwomax", "isshastick",
		"ismurrash", "islaori", "isthadyri", "isterran", "istrulor",
		"isdragon", "isdeva", "issolar",
		"\n"			//	16-18
	};
	int i;
	 ...
	 */
	switch (i) {
		case 0:		*value = GET_STAT(ch, Str);	break;
		case 1:		*value = GET_STAT(ch, Int);	break;
		case 2:		*value = GET_STAT(ch, Wis);	break;
		case 3:		*value = GET_STAT(ch, Dex);	break;
		case 4:		*value = GET_STAT(ch, Con);	break;
		case 5:		*value = GET_STAT(ch, Cha);	break;
		
		case 6:		*value = time_info.hours;	break;
		case 7:		*value = GET_LEVEL (ch);	break;
		case 8:		*value = GET_WEIGHT(ch);	break;
		case 9:		*value = GET_HEIGHT(ch);	break;

		case 10:	*value = IS_ANIMAL(ch);		break;
		case 11:	*value = IS_HYUMANN(ch);	break;
		case 12:	*value = IS_ELF(ch);		break;
		case 13:	*value = IS_DWOMAX(ch);		break;
		case 14:	*value = IS_SHASTICK(ch);	break;
		case 15:	*value = IS_MURRASH(ch);	break;
		case 16:	*value = IS_LAORI(ch);		break;
		case 17:	*value = IS_THADYRI(ch);	break;
		case 18:	*value = IS_TERRAN(ch);		break;
		case 19:	*value = IS_TRULOR(ch);		break;
		case 20:	*value = IS_DRAGON(ch);		break;
		case 21:	*value = IS_DEVA(ch);		break;
		case 22:	*value = IS_SOLAR(ch);		break;
